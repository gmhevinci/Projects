...
{
    unsafe class MotionFramework_Tween_SequenceNode_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(MotionFramework.Tween.SequenceNode);
        ...
        static StackObject* Allocate_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = MotionFramework.Tween.SequenceNode.Allocate(@nodes);
