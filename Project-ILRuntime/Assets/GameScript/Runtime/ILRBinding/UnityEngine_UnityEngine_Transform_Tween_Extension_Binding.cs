...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UnityEngine_Transform_Tween_Extension_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(UnityEngine.Transform), typeof(System.Single), typeof(UnityEngine.Vector3), typeof(System.Boolean)};
            method = type.GetMethod("ShakePosition", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ShakePosition_2);
        ...
        static StackObject* ShakePosition_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 4);
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UnityEngine.Vector3 @magnitude = new UnityEngine.Vector3();
            if (ILRuntime.Runtime.Generated.CLRBindings.s_UnityEngine_Vector3_Binding_Binder != null) {
                ILRuntime.Runtime.Generated.CLRBindings.s_UnityEngine_Vector3_Binding_Binder.ParseValue(ref @magnitude, __intp, ptr_of_this_method, __mStack, true);
            } else {
                @magnitude = (UnityEngine.Vector3)typeof(UnityEngine.Vector3).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
                __intp.Free(ptr_of_this_method);
            }
            ...
            var result_of_this_method = UnityEngine.UnityEngine_Transform_Tween_Extension.ShakePosition(@obj, @duration, @magnitude, @relativeWorld);
