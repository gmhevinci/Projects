...
namespace MotionFramework.AI
{
	public class IFsmNodeAdapter : CrossBindingAdaptor
	{
		...
		public class Adapter : MotionFramework.AI.IFsmNode, CrossBindingAdaptorType
		{
			...
			CrossBindingMethodInfo mOnExit_3 = new CrossBindingMethodInfo("OnExit");
			CrossBindingMethodInfo<System.Object> mOnHandleMessage_4 = new CrossBindingMethodInfo<System.Object>("OnHandleMessage");
